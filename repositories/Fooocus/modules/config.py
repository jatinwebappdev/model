...
default_prompt_negative = get_config_item_or_set_default(
    ...
    default_value=' duplicate, deformed, distorted, disfigured, poorly drawn, bad anatomy, wrong anatomy, extra limb, missing limb, floating limbs, disconnected limbs, mutation, mutated, ugly, disgusting, blurry, amputation, extra fingers, missing fingers, extra hands, missing hands, extra legs, missing legs',
    validator=lambda x: isinstance(x, str),
